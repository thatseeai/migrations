...
<SideBySide leftTitle="Before (Angular Animations)" rightTitle="After (Framer Motion)">
  <div slot="left">
...
<SideBySide leftTitle="Before (Angular)" rightTitle="After (Framer Motion)">
  <div slot="left">
...
<SideBySide leftTitle="Before (Angular)" rightTitle="After (Framer Motion + React Router)">
  <div slot="left">
