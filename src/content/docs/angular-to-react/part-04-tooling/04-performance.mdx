...
<SideBySide leftTitle="최적화 전" rightTitle="React.memo 적용">
  <div slot="left">
...
<SideBySide leftTitle="최적화 전" rightTitle="useMemo 적용">
  <div slot="left">
...
<SideBySide leftTitle="최적화 전" rightTitle="useCallback 적용">
  <div slot="left">
...
<SideBySide leftTitle="전체 번들 로드" rightTitle="Lazy Loading">
  <div slot="left">
...
<SideBySide leftTitle="10,000개 항목 렌더링" rightTitle="react-window 사용">
  <div slot="left">
...
<SideBySide leftTitle="매 입력마다 API 호출" rightTitle="Debounced search">
  <div slot="left">
...
<SideBySide leftTitle="메인 스레드 블로킹" rightTitle="Web Worker 사용">
  <div slot="left">
