...
<SideBySide leftTitle="Before (Angular)" rightTitle="After (React 18+ with Vite)">
  <div slot="left">
...
<SideBySide leftTitle="Angular: src/main.ts" rightTitle="React: src/main.tsx">
  <div slot="left">
...
<SideBySide leftTitle="Angular: src/index.html" rightTitle="React: index.html">
  <div slot="left">
...
<SideBySide leftTitle="Angular: environment.ts" rightTitle="React: .env">
  <div slot="left">
